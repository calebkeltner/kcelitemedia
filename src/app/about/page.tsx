...
import imageCaleb from '@/images/team/Caleb.jpg'
import imageEmma from '@/images/team/Emma.jpg'
import imageTed from '@/images/team/Ted.jpeg'
...
export default async function About() {
  ...
  return (
    <>
      ...
      <Container className="mt-16">
        <StatList>
          <StatListItem value="3" label="Unhappy Employees" />
          <StatListItem value="20+" label="Years of experience in marketing" />
