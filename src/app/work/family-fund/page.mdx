...
export const caseStudy = {
  client: 'Buck Tui BBQ',
  title: 'Punchy Catchline',
  description:
    'Buck Tui BBQ is an award winning Thai BBQ restaurant in Overland Park, Kansas.',
  summary: [
    'Summary: Buck Tui BBQ is an award winning Thai BBQ restaurant in Overland Park, Kansas.',
  ],
  logo,
  image: { src: imageHero },
  date: '2023-01',
  service: 'Social Media Revamp, Tech Advisement',
  testimonial: {
    author: { name: 'Ted Liberda', role: 'Founder of Buck Tui BBQ' },
    content:
